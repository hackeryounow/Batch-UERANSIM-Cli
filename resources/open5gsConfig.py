from resources.ip import open5gsIP, webUIPort
commands = [
    'ps-establish',
    'ps-list',
    'ps-release',
...
csrf_url = "http://" + open5gsIP + ":" + webUIPort + "/api/auth/csrf"
headers_ = {
    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36"
}

login_url = "http://" + open5gsIP + ":" + webUIPort + "/api/auth/login"
...
session_url = "http://" + open5gsIP + ":" + webUIPort + "/api/auth/session"
headers_hascookie = {
    "User-Agent": headers_["User-Agent"],
    "Cookie": ""
}

subscriber_url = "http://" + open5gsIP + ":" + webUIPort + "/api/db/Subscriber"
headers_auth = {
